...
import { GifIcon, GlobeAsiaAustraliaIcon, PuzzlePieceIcon } from '@heroicons/vue/20/solid'
      ...
      <div class="grid grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
        <div class="px-6 lg:px-0 lg:pt-4 lg:pr-4">
          <div class="max-w-2xl mx-auto lg:mx-0 lg:max-w-lg">
            <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">海量模版</p>
            <p class="mt-6 text-lg leading-8 text-gray-600">内置海量模版，帮助您快速开始</p>
        ...
        <div class="sm:px-6 lg:px-0">
          <div
            class="relative px-6 pt-8 overflow-hidden bg-teal-500 isolate sm:mx-auto sm:max-w-2xl sm:rounded-3xl sm:pt-16 sm:pl-16 sm:pr-0 lg:mx-0 lg:max-w-none"
          >
            <div
            ...
            <div class="max-w-2xl mx-auto sm:mx-0 sm:max-w-none">
              <img
                ...
                width="2432"
                height="1442"
                class="px-4 pt-4 bg-gray-700 rounded-tl-xl ring-1 ring-white/10"
              />
            </div>
