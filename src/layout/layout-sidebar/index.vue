...
const navigation = ref([
  {
    ...
    children: [
      ...
      { name: '功能说明', path: '/chat-funcdesc', type: 'path', icon: 'hugeicons:dashboard-square-02', current: false },
    ],
  },
  {
    name: 'AI 问卷',
    ...
    children: [
      ...
      { name: '功能说明', path: '/questionnaire-funcdesc', type: 'path', icon: 'hugeicons:dashboard-square-02', current: false },
    ],
  },
