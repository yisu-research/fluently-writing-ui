...
<template>
  <div class="absolute top-0 z-40 w-full bg-white/80 lg:mx-auto lg:max-w-7xl lg:px-8 backdrop-filter backdrop-blur-md">
    <div
    ...
    >
      <button type="button" class="-m-2.5 p-2.5 text-gray-700 lg:hidden" @click="toggleSidebar">
        ...
        <SvgIcon icon="heroicons-solid:menu-alt-2" class="w-6 h-6" />
      </button>
    </div>
  </div>
</template>
